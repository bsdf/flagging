...
public class ActivityMainTabs extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        ViewThreadsFragment snaFragment = ViewThreadsFragment.newInstance();
        adapter.addFragment(snaFragment, "New Answers");
        adapter.addFragment(new ViewBoardsFragment(), "Boards");
